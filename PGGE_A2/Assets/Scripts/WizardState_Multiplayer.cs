...
public class WizardState_Multiplayer : FSMState
{
    protected Wizard_Multiplayer mWizard = null;

    public WizardState_Multiplayer(Wizard_Multiplayer wizard)
        : base()
    {
        mWizard = wizard;
        mFsm = mWizard.mFsm;
...
public class WizardState_Multiplayer_MOVEMENT : Wizard_Multiplayer
{
    public WizardState_Multiplayer_MOVEMENT(Wizard_Multiplayer wizard) : base(wizard)
    {
